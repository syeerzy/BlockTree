...
namespace BlockTree.UI
{
    public partial class AssetRegisterDialog : Form
    {
        ...
        public InvocationTransaction GetTransaction()
        {
            ...
            Fixed10 amount = checkBox1.Checked ? Fixed10.Parse(textBox2.Text) : -Fixed10.Satoshi;
            ...
            {
                sb.EmitSysCall("BlockTree.Asset.Create", asset_type, name, amount, precision, owner, admin, issuer);
