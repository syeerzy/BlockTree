...
namespace BlockTree.Network.RPC
{
            ...
            switch (method)
            {
                ...
                case "sendfrom":
                    ...
                    else
                    {
                        ...
                        Fixed10 fee = _params.Count >= 5 ? Fixed10.Parse(_params[4].AsString()) : Fixed10.Zero;
                        if (fee < Fixed10.Zero)
                            throw new RpcException(-32602, "Invalid params");
                ...
                case "sendtoaddress":
                    ...
                    else
                    {
                        ...
                        if (value.Sign <= 0)
                            throw new RpcException(-32602, "Invalid params");
                        Fixed10 fee = _params.Count >= 4 ? Fixed10.Parse(_params[3].AsString()) : Fixed10.Zero;
                        if (fee < Fixed10.Zero)
                            throw new RpcException(-32602, "Invalid params");
                ...
                case "sendmany":
                    ...
                    else
                    {
                        ...
                        Fixed10 fee = _params.Count >= 2 ? Fixed10.Parse(_params[1].AsString()) : Fixed10.Zero;
                        if (fee < Fixed10.Zero)
                            throw new RpcException(-32602, "Invalid params");
                ...
                case "invokescript":
                    ...
                    if (Program.Wallet != null)
                    {
                        InvocationTransaction tx = new InvocationTransaction
                        {
                            ...
                            Gas = Fixed10.Parse(result["gas_consumed"].AsString())
                        };
                        tx.Gas -= Fixed10.FromDecimal(10);
