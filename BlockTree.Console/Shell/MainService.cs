...
using BlockTree.Network.Payloads;
using BlockTree.Network.RPC;
using BlockTree.Services;
...
using ECCurve = BlockTree.Cryptography.ECC.ECCurve;
using ECPoint = BlockTree.Cryptography.ECC.ECPoint;

namespace BlockTree.Shell
{
    internal class MainService : ConsoleServiceBase
    {
        ...
        protected override string Prompt => "tree";
        public override string ServiceName => "BlockTree-Console";
        ...
        private bool OnSendCommand(string[] args)
        {
            ...
            else
            {
                ...
                Fixed10 fee = args.Length >= 5 ? Fixed10.Parse(args[4]) : Fixed10.Zero;
