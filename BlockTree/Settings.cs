...
namespace BlockTree
{
    internal class Settings
    {
        ...
        public IReadOnlyDictionary<TransactionType, Fixed10> SystemFee { get; private set; }
        ...
        public Settings(IConfigurationSection section)
        {
            ...
            this.SystemFee = section.GetSection("SystemFee").GetChildren().ToDictionary(p => (TransactionType)Enum.Parse(typeof(TransactionType), p.Key, true), p => Fixed10.Parse(p.Value));
