...
namespace BlockTree.Consensus
{
    public class ConsensusService : IDisposable
    {
        ...
        private void FillContext()
        {
            ...
            Fixed10 amount_netfee = Block.CalculateNetFee(transactions);
            TransactionOutput[] outputs = amount_netfee == Fixed10.Zero ? new TransactionOutput[0] : new[] { new TransactionOutput
            {
