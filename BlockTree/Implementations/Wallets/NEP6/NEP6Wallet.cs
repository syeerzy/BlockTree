...
using UserWallet = BlockTree.Implementations.Wallets.EntityFramework.UserWallet;

namespace BlockTree.Implementations.Wallets.NEP6
{
    public class NEP6Wallet : Wallet, IDisposable
    {
        ...
        public override Coin[] FindUnspentCoins(UInt256 asset_id, Fixed10 amount, UInt160[] from)
        {
