...
namespace BlockTree.Core
{
    public class AccountState : StateBase, ICloneable<AccountState>
    {
        ...
        public Dictionary<UInt256, Fixed10> Balances;
        ...
        public AccountState(UInt160 hash)
        {
            ...
            this.Balances = new Dictionary<UInt256, Fixed10>();
        }
        ...
        public override void Deserialize(BinaryReader reader)
        {
            ...
            Balances = new Dictionary<UInt256, Fixed10>(count);
            for (int i = 0; i < count; i++)
            {
                UInt256 assetId = reader.ReadSerializable<UInt256>();
                Fixed10 value = reader.ReadSerializable<Fixed10>();
        ...
        {
            if (!Balances.TryGetValue(asset_id, out Fixed10 value))
                value = Fixed10.Zero;
            return value;
        }
        ...
        public override void Serialize(BinaryWriter writer)
        {
            ...
            writer.Write(Votes);
            var balances = Balances.Where(p => p.Value > Fixed10.Zero).ToArray();
